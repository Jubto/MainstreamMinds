...
class ResearchStoryRepository():
    ...
    def create(self, create_story: ResearchStoryCreate) -> ResearchStory:
        story = ResearchStory()
        assign_members_from_dict(story, create_story.dict(exclude_unset=True, exclude={"authors", "tags"}))
    ...
    def update(self, story: ResearchStory, update_story: ResearchStoryUpdate) -> ResearchStory:
        assign_members_from_dict(story, update_story.dict(exclude_unset=True, exclude={"authors", "tags"}))
